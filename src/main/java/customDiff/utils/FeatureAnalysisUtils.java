...
public class FeatureAnalysisUtils {
	...
	public static VariationPoint getVariationPointOfChangedProductAssetLine(String relPath, CoreAssetBaseline baseline2,
		...
		while (it.hasNext()) {
			vp = it.next();
			// System.out.println(" Line init:" +vp.getLineInit()+ "; Line end: "+
			// vp.getLineEnd());
	...
	public static HashMap<Integer, ArrayList<String>> extractFeatureMapFromFile(SourceCodeFile file,
			CoreAssetBaseline baseline) {// Read the file lineByLine
