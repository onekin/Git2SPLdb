...
CREATE TABLE IF NOT EXISTS `mydb`.`CoreAsset` (
  ...
  `size` INT NOT NULL,
  `CoreAssetBaseline_idBaseline` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Product` (
  ...
  `name` VARCHAR(45) NULL,
  `ProductPortfolio_idPortfolio` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`ProductAsset` (
  ...
  `content` LONGTEXT NOT NULL,
  `size` INT NOT NULL,
  `ProductRelease_idRelease` INT NOT NULL,
