...
-- Schema MARLIN
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `MARLIN` DEFAULT CHARACTER SET utf8 ;
USE `MARLIN` ;

-- -----------------------------------------------------
-- Table `MARLIN`.`component_package`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`component_package` (
...
-- -----------------------------------------------------
-- Table `MARLIN`.`core_asset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`core_asset` (
  ...
  CONSTRAINT `fk_core_asset_component_package1`
    ...
    REFERENCES `MARLIN`.`component_package` (`idpackage`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MARLIN`.`feature_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`feature_group` (
...
-- -----------------------------------------------------
-- Table `MARLIN`.`variation_point`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`variation_point` (
  ...
  CONSTRAINT `fk_ProductAssetVP_ProductAsset1`
    ...
    REFERENCES `MARLIN`.`core_asset` (`idcoreasset`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_VariationPoint_Feature_group1`
    FOREIGN KEY (`id_feature_group`)
    REFERENCES `MARLIN`.`feature_group` (`id_feature_group`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MARLIN`.`developer_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`developer_group` (
...
-- -----------------------------------------------------
-- Table `MARLIN`.`product_release`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`product_release` (
...
-- -----------------------------------------------------
-- Table `MARLIN`.`customization_fact`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`customization_fact` (
...
-- -----------------------------------------------------
-- Table `MARLIN`.`parent_feature`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`parent_feature` (
...
-- -----------------------------------------------------
-- Table `MARLIN`.`feature`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`feature` (
  ...
  CONSTRAINT `fk_feature_ParentFeature1`
    ...
    REFERENCES `MARLIN`.`parent_feature` (`idparentfeature`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MARLIN`.`feature_bridge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`feature_bridge` (
  `id_feature_group` INT NOT NULL,
  ...
  CONSTRAINT `fk_Feature_group_has_Feature_Feature1`
    ...
    REFERENCES `MARLIN`.`feature` (`idfeature`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MARLIN`.`developer_bridge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`developer_bridge` (
  `id_developer_group` INT NOT NULL,
  ...
  CONSTRAINT `fk_developer_bridge_Developer1`
    ...
    REFERENCES `MARLIN`.`developer` (`iddeveloper`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`new_assets_in_products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`new_assets_in_products` (`'id'` INT, `'idasset'` INT, `'name'` INT, `'path'` INT, `'content'` INT, `'size'` INT, `'pr_id'` INT, `'pr_name'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`features_in_variationpoints`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`features_in_variationpoints` (`'id'` INT, `'id_variationpoint'` INT, `expression` INT, `'feature_name'` INT, `'id_feature'` INT, `'id_coreasset'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`churn_productportfolio_features`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`churn_productportfolio_features` (`'id'` INT, `'id_feature'` INT, `'featuremodified'` INT, `'id_pr'` INT, `'pr_name'` INT, `'added'` INT, `'deleted'` INT, `'churn'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`churn_coreassets_and_features_by_pr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`churn_coreassets_and_features_by_pr` (`'id'` INT, `'idcoreasset'` INT, `'idproductrelease'` INT, `'pr_name'` INT, `'ca_name'` INT, `'ca_path'` INT, `'idfeature'` INT, `'churn'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`coreassets_and_features`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`coreassets_and_features` (`'id'` INT, `'idcoreasset'` INT, `'caname'` INT, `'capath'` INT, `'idpackage'` INT, `'idfeature'` INT, `'size'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`customs_by_feature_and_coreasset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`customs_by_feature_and_coreasset` (`'id'` INT, `'idcustomization'` INT, `'idfeature'` INT, `'idcoreasset'` INT, `'idparentfeature'` INT, `'parentfeaturename'` INT, `'caname'` INT, `'capath'` INT, `'idproductrelease'` INT, `'prname'` INT, `'added'` INT, `'deleted'` INT, `'custom_diff'` INT, `'messages'` INT, `'commits'` INT, `'maindiff'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`churn_parent_features_productportfolio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`churn_parent_features_productportfolio` (`'id'` INT, `'id_parentfeature'` INT, `'parentfeaturename'` INT, `'id_pr'` INT, `'pr_name'` INT, `'added'` INT, `'deleted'` INT, `'churn'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`churn_parent_features_product_packages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`churn_parent_features_product_packages` (`'id'` INT, `'id_parentfeature'` INT, `'parentfeaturename'` INT, `'idproductrelease'` INT, `'pr_name'` INT, `'idpackage'` INT, `'package_name'` INT, `'isroot'` INT, `'added'` INT, `'deleted'` INT, `'churn'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`churn_parent_features_package_assets`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`churn_parent_features_package_assets` (`'id'` INT, `'id_parentfeature'` INT, `'parentfeaturename'` INT, `'idproductrelease'` INT, `'pr_name'` INT, `'idpackage'` INT, `'package_name'` INT, `'isroot'` INT, `'idcoreasset'` INT, `'caname'` INT, `'capath'` INT, `'added'` INT, `'deleted'` INT, `'churn'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`churn_features_product_packages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`churn_features_product_packages` (`'id'` INT, `'idfeature'` INT, `'featurename'` INT, `'idparentfeature'` INT, `'idproductrelease'` INT, `'pr_name'` INT, `'idpackage'` INT, `'package_name'` INT, `'isroot'` INT, `'added'` INT, `'deleted'` INT, `'churn'` INT);

-- -----------------------------------------------------
-- Placeholder table for view `MARLIN`.`churn_features_package_assets`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MARLIN`.`churn_features_package_assets` (`'id'` INT, `'idfeature'` INT, `'featurename'` INT, `'idparentfeature'` INT, `'idproductrelease'` INT, `'pr_name'` INT, `'idpackage'` INT, `'package_name'` INT, `'isroot'` INT, `'idcoreasset'` INT, `'caname'` INT, `'capath'` INT, `'added'` INT, `'deleted'` INT, `'churn'` INT);

-- -----------------------------------------------------
-- View `MARLIN`.`new_assets_in_products`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`new_assets_in_products`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`features_in_variationpoints`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`features_in_variationpoints`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`churn_productportfolio_features`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`churn_productportfolio_features`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`churn_coreassets_and_features_by_pr`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`churn_coreassets_and_features_by_pr`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`coreassets_and_features`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`coreassets_and_features`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`customs_by_feature_and_coreasset`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`customs_by_feature_and_coreasset`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`churn_parent_features_productportfolio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`churn_parent_features_productportfolio`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`churn_parent_features_product_packages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`churn_parent_features_product_packages`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`churn_parent_features_package_assets`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`churn_parent_features_package_assets`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`churn_features_product_packages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`churn_features_product_packages`;
USE `MARLIN`;
...
-- -----------------------------------------------------
-- View `MARLIN`.`churn_features_package_assets`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MARLIN`.`churn_features_package_assets`;
USE `MARLIN`;
